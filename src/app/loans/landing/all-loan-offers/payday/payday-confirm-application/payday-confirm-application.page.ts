...
import { IPaydayLoanRepaymentCalcResp } from 'src/app/models/loan/IPaydayLoanRepaymentCalcResp';
...
@Component({
  selector: 'app-payday-confirm-application',
  templateUrl: './payday-confirm-application.page.html',
  styleUrls: ['./payday-confirm-application.page.scss'],
})
export class PaydayConfirmApplicationPage implements OnInit {
